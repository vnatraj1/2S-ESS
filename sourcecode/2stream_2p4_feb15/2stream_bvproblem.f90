...
!write(0,*) 'R2_PARTIC',WLOWER(1,NLAYERS),STREAM_VALUE,SURFACE_FACTOR,ALBEDO,FACTOR
...
!write(0,*) 'SURFACE_TERM',SURFACE_TERM

!  Upper boundary for layer 1: no downward diffuse radiation

      TOA_TERM  = - WUPPER(1,1)

!write(0,*) 'TOA_TERM',TOA_TERM
...
!write(0,*) 'COL',N,COL(NM),COL(NP)
          ENDDO
          COL(NTOTAL) = SURFACE_TERM
!write(0,*) 'COL',NTOTAL,COL(NTOTAL)
        endif
