...
! #                                                             #
! #              TWOSTREAM_WRITE_STD_INPUT_SOLAR_OBS            #
! #              TWOSTREAM_WRITE_SUP_BRDF_INPUT_SOLAR_OBS       #
! #              TWOSTREAM_WRITE_SUP_SLEAVE_INPUT_OBS           #
! #                                                             #
! ###############################################################

      MODULE twostream_writemodules_solar_obs_m

      PRIVATE

      PUBLIC :: TWOSTREAM_WRITE_STD_INPUT_SOLAR_OBS, &
                TWOSTREAM_WRITE_SUP_BRDF_INPUT_SOLAR_OBS, &
                TWOSTREAM_WRITE_SUP_SLEAVE_INPUT_OBS
...
!  ==================================
      ...
      SUBROUTINE TWOSTREAM_WRITE_STD_INPUT_SOLAR_OBS ( &
...
!  Write all input to file
      ...
      WRITE(OUTUNIT,DWFL)  'DO_MVOUT_ONLY        = ',DO_INCLUDE_MVOUT(0) .AND. .NOT. DO_POSTPROCESSING
      WRITE(OUTUNIT,DWFL)  'DO_ADDITIONAL_MVOUT  = ',DO_INCLUDE_MVOUT(0)
      WRITE(OUTUNIT,DWFL)  'DO_SOLAR_SOURCES     = ',.TRUE.
      WRITE(OUTUNIT,DWFL)  'DO_THERMAL_EMISSION  = ',.FALSE.
      WRITE(OUTUNIT,DWFL)  'DO_SURFACE_EMISSION  = ',.FALSE.
...
!  Close output file
      ...
      END SUBROUTINE TWOSTREAM_WRITE_STD_INPUT_SOLAR_OBS

!

      SUBROUTINE TWOSTREAM_WRITE_SUP_BRDF_INPUT_SOLAR_OBS ( &
...
!  Write all BRDF input to file
      ...
      DO IB=1,N_USER_OBSGEOMS
        DO MOM=0,NMOMENTS
          WRITE(OUTUNIT,DWFR2) &
            'IB = ',IB,' MOM = ',MOM,&
            ' BRDF_F_0(IB,MOM) = ',BRDF_F_0(IB,MOM)
        END DO
      END DO
...
!  Close output file
      ...
      END SUBROUTINE TWOSTREAM_WRITE_SUP_BRDF_INPUT_SOLAR_OBS

!

      SUBROUTINE TWOSTREAM_WRITE_SUP_SLEAVE_INPUT_OBS ( &
        MAX_USER_OBSGEOMS, N_USER_OBSGEOMS,&
...
!  Write all surface-leaving input to file
      ...
      DO IB=1,N_USER_OBSGEOMS
        DO MOM=0,NMOMENTS
          WRITE(OUTUNIT,DWFR2) &
            'IB = ',IB,' MOM = ',MOM,&
            ' SLTERM_F_0(IB,MOM) = ',SLTERM_F_0(IB,MOM)
        END DO
      END DO
...
!  Close output file
      ...
      END SUBROUTINE TWOSTREAM_WRITE_SUP_SLEAVE_INPUT_OBS

      END MODULE twostream_writemodules_solar_obs_m
