...
!  Help
   ...
   integer    :: n, j, nj, q, v, uta, nstart, nc, nut, nut_prev, Qnums(maxlayers)
...
subroutine DTE_Integral_ILCS_UPDN &
   ( maxgeoms, maxlayers, maxfinelayers, max_user_levels,         & ! Inputs (dimensioning)
     ...
     LC_Jacobians_dta_up, LC_Jacobians_dts_up, LS_Jacobians_dts,  & ! Output
     LC_Jacobians_dta_dn, tcom1, L_tcom1 )                          ! Output
